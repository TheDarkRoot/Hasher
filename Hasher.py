...
def info():
	...
	print (YY+"\n     ["+WW+"01"+YY+"] "+CC+"md4             "+YY+"["+WW+"09"+YY+"] "+CC+"whirlpool")
	print (YY+"     ["+WW+"02"+YY+"] "+CC+"md5             "+YY+"["+WW+"10"+YY+"] "+CC+"MySQL 3.2.3")
	print (YY+"     ["+WW+"03"+YY+"] "+CC+"sha1            "+YY+"["+WW+"11"+YY+"] "+CC+"MySQL 4.1")
	print (YY+"     ["+WW+"04"+YY+"] "+CC+"sha224          "+YY+"["+WW+"12"+YY+"] "+CC+"MSSQL 2000")
	print (YY+"     ["+WW+"05"+YY+"] "+CC+"sha256          "+YY+"["+WW+"13"+YY+"] "+CC+"MSSQL 2005")
	print (YY+"     ["+WW+"06"+YY+"] "+CC+"sha384          "+YY+"["+WW+"14"+YY+"] "+CC+"Nthash")
	print (YY+"     ["+WW+"07"+YY+"] "+CC+"sha512          "+YY+"["+WW+"15"+YY+"] "+CC+"lmhash")
	print (YY+"     ["+WW+"08"+YY+"] "+CC+"ripemd160       "+YY+"["+WW+"16"+YY+"] "+CC+"NTLM hash\n"+W)
